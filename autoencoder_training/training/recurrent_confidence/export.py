...
CHECKPOINT_PATH  = Path("model_output_recurrent_C24/autoencoder_best.pt")
ONNX_OUTPUT_PATH = Path("../../../public/models/RecurrentDenoisingAutoencoderConfidence_FINAL_C24.onnx")
