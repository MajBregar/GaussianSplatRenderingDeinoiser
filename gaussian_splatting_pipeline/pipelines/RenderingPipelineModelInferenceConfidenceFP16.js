...
export class RenderingPipelineModelInferenceConfidenceFP16 {
    constructor({
    ...
    async #renderFrame() {
        ...
        let screenOutputTexture;
        if (this.renderMode == 0) {
            screenOutputTexture = this.inferenceOutputTexture;
        } else {
            screenOutputTexture = this.directColorTexture_A;
        }
